...
El flux d'execució d'un programa a sobre d'un computador es pot resumir en tres blocs o fases: bloc d'entrada, bloc de procés i bloc de sortida.
...
## El bloc de procés
En segon lloc, ens trobem amb el bloc de procés. En aquest bloc es defineixen les instruccions que defineixen el comportament del programa. És a dir, es descriu què s'ha de fer (**processar**) amb les dades que s'han captat al bloc anterior.
