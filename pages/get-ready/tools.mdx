...
A l'esquerra del tot tenim el menú selector del llenguatge de programació que farem servir; NO cal tocar-ho, ja que per defecte ve seleccionat Python.
...
Finalment, a la banda dreta ens trobem amb la consola. Aquí és on es produiran totes les interaccions amb el computador. Podrem veure, per exemple, els errors que es produeixin o el que pugui escriure el programa.
<div align="center">
...
## Jutge.org
Per altra banda, farem servir el [jutge.org](jutge.org) per posar a prova els nostres coneixements. El Jutge és una eina desenvolupada per professors de la Facultat d'Informàtica de Barcelona, de la Universitat Politècnica de Catalunya on ens podem trobar multitud de problemes i reptes de programació.
...
6. Un cop dins la plataforma, ens trobarem amb una vista semblant a la següent. Si ho creiem necessari, podem accedir a l'apartat de configuració per canviar la nostra contrasenya.
<div align="center">
