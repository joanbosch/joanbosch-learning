...
Ara bé, la funció `input()` sempre retorna un valor de tipus text. Si volem que el valor d'entrada sigui d'un altre tipus (com enter o real) haurem de fer servir les funcions `int()` o `double()` respectivament. 
Vegem un exemple:
```python
