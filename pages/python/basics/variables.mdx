...
Per exemple, suposem que volem que el nostre programa mostri el resultat de la suma 2 + 3. Llavors, podriem guardar el resultat d'aquesta operació a una variable i llavors escriure el seu valor:
